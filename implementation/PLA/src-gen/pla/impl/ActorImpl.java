...
public abstract class ActorImpl extends MinimalEObjectImpl.Container implements Actor {
	...
	protected EClass eStaticClass() {
		return PlaPackage.Literals.ACTOR;
	}
	...
	public void setID(String newID) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PlaPackage.ACTOR__ID, oldID, id));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PlaPackage.ACTOR__NAME, oldName, name));
	}
	...
	public void setContact(String newContact) {
		...
		contact = newContact;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PlaPackage.ACTOR__CONTACT, oldContact, contact));
	}
	...
	public void setAddress(String newAddress) {
		...
		address = newAddress;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PlaPackage.ACTOR__ADDRESS, oldAddress, address));
	}
