...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Security Contract Type</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see org.secdfd.model.ModelPackage#getSecurityContractType()
 * @model
 * @generated
 */
public enum SecurityContractType implements Enumerator {
	/**
	...
	/**
	 * An array of all the '<em><b>Security Contract Type</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final SecurityContractType[] VALUES_ARRAY =
		new SecurityContractType[] {
			STORE,
			COMPARATOR,
			DISCARDER,
			JOINER,
	...
	/**
	 * A public read-only list of all the '<em><b>Security Contract Type</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<SecurityContractType> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Security Contract Type</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static SecurityContractType get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			SecurityContractType result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Security Contract Type</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param name the name.
	 * @return the matching enumerator or <code>null</code>.
	 * @generated
	 */
	public static SecurityContractType getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			SecurityContractType result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Security Contract Type</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static SecurityContractType get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private SecurityContractType(int value, String name, String literal) {
		this.value = value;
		this.name = name;
